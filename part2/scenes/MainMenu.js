let MainMenu = {
    ...
    setup: function () {
        this.selection = 0;
        this.cursor = createVector(width / 2 - 110, height / 2);
    },
    draw: function () {
        push();
        background(0);
        ...
        stroke(255,0,0);
        strokeWeight(5);
        rect(25,100, width-50, 250);

        fill(255);
        textAlign(CENTER);
        textSize(130);
        text(GM.title, width / 2, height / 3);
        ...
        textSize(33);
        text("HIGHSCORES", width / 2 - 50, height / 2 + 60);
        textSize(33);
        text("INSTRUCTIONS", width / 2 - 50, height / 2 + 110);
        pop();
